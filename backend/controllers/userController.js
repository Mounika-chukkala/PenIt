...
dotenv.config();
import {FIREBASE_ADMIN_TYPE, FIREBASE_PROJECT_ID,FIREBASE_PRIVATE_KEY_ID,FIREBASE_PRIVATE_KEY,FIREBASE_CLIENT_EMAIL,FIREBASE_CLIENT_ID,FIREBASE_AUTH_URI,FIREBASE_TOKEN_URI,FIREBASE_AUTH_PROVIDER,FIREBASE_CLIENT_CERT_URL,FIREBASE_UNIVERSE_DOMAIN, EMAIL_USER, FRONTEND_URL } from "../config/dotenv.config.js";
admin.initializeApp({
