  ...
  return (
    <nav className="bg-white shadow-md px-6 py-4 flex justify-between items-center rounded-b-lg">
      ...
      <ul className="flex space-x-6 font-medium">
        ...
        <li className="bg-[#059669]/70 rounded-md px-3 py-2 text-black/60 transform hover:scale-120 transition duration-300 ease-in-out  hover:text-white cursor-pointer">Sign In</li>
