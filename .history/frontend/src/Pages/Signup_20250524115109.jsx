...
alert(res.message)    
  ...
  return (
      ...
      <div className="hidden sm:flex w-1/3  flex-col justify-center items-center p-10 bg-gradient-to-br from-[#6EE7B7] to-[#A7F3D0]">
...
<p className="text-[11px] md:text-[12px] text-black/60 mb-3">Already having an account ? <Link to="/signin"><span className="text-blue-400">Login</span></Link></p>
