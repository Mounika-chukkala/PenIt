...
function Signin() {
  ...
  return (
    <motion.div
      className="max-h-screen max-w-[60%] md:max-w-[30%] rounded-md m-auto mt-[100px] flex bg-[#F0FDF4] text-[#1E293B]"
    ...
    >
      ...
      >
        <h2 className="text-xl md:text-2xl font-bold mb-3 text-[#10B981]">Log into your account</h2>
