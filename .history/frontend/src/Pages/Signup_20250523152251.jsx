  ...
  return (
      ...
      <div className=" w-full md:w-2/3 flex justify-center items-center p-10">
        <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
          <h2 className="text-xl md:text-2xl font-bold mb-3 text-[#10B981]">Create an account</h2>

<p className="text-[11px] md:text-[12px] text-black/60 mb-3">Already having an account ? <Link to="/login"><span className="text-blue-400">Login</span></Link></p>
