      ...
      if (userData.private) {
        ...
        return isOwnerOrFollower ? (
          ...
          <p className="text-sm text-gray-400">
            This user's blogs are private.
          </p>
        );
      } else {
        return (
          <DisplayBlogs
            blogs={userData.blogs.filter(
              (blog) => !blog.draft && !blog.private
            )}
          />
        );
      }
          ...
          <div className="py-5 w-full  lg:w-[40%]  max-lg:flex lg:pl-10">
            <div className="my-6 ">
              ...
              <div className="flex my-2 gap-2">
                ...
                <p className="my-1 text-slate-500 line-clamp-1 text-xs ">
                  {" "}
              ...
              <div className="flex gap-3">
                <p
                  className="text-gray-600 text-xs mb-1 cursor-pointer"
                  onClick={() =>
                    isSmallScreen()
                ...
                <p
                  className="text-gray-600 text-xs cursor-pointer mb-1"
                  onClick={() =>
                    isSmallScreen()
                      ? navigate(`/followers/${username}`)
              ...
              <div className="my-4 hidden lg:block">
                <h2 className="text-sm font-medium mb-2">
                  {followerSection == "followers" ? "Followers" : "Following"}
                </h2>
                ...
                {userData?.showFollowers ? (
                  ...
                  <p className="text-xs text-slate-500 mx-auto">
                    ...
                    don't want to disclose his followers and following...
                  </p>
                )}
              </div>
            </div>
